...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if context.user_data.get("state") == "cardio_in_progress":
        ...
        if text == "✅ Done":
            ...
            # بعد از پایان تمرین دکمه‌های انتخاب روزهای هوازی و بازگشت به منوی اصلی
            keyboard = ReplyKeyboardMarkup(
                [
                    ["🏃‍♂️ روز اول", "🏃‍♂️ روز دوم"],
            ...
            await update.message.reply_text("✅ برنامه هوازی برای ۴ روز آماده‌ست. یکی از روزها رو انتخاب کن:", reply_markup=keyboard)
            ...
            if idx >= len(cardio_gifs[day]):
                ...
                await update.message.reply_text("یکی از روزها رو انتخاب کن یا به منوی اصلی برگرد:", reply_markup=keyboard)
            else:
        ...
        elif text == "🔙 بازگشت به روزهای هوازی":
            keyboard = ReplyKeyboardMarkup(
                [
                    ["🏃‍♂️ روز اول", "🏃‍♂️ روز دوم"],
                    ["🏃‍♂️ روز سوم", "🏃‍♂️ روز چهارم"],
